  ...
  writing: {
    ...
    c6: {
      ...
      values: {
        ...
        长度: ['One-liner (1-2 sentences)', 'Brief (3-5 sentences)', 'Standard (1-2 paragraphs)', 'Detailed (3-5 paragraphs)', 'Bullet Points'],
      },
      defaults: {
        邮件类型: '工作汇报',
        正式程度: '正式',
    ...
    c7: {
      ...
      values: {
        ...
        篇幅: ['Abstract (300 words)', 'Short Paper (1500 words)', 'Standard Paper (5000 words)', 'Long Paper (8000 words)', 'Thesis (20000+ words)'],
      },
      defaults: {
        论文类型: '研究论文',
        学科领域: '社会科学',
    ...
    c8: {
      ...
      values: {
        ...
        篇幅: ['Quick Reference (1 page)', 'Getting Started (2-3 pages)', 'Standard Doc (5-10 pages)', 'Full Manual (20+ pages)', 'Doc Series'],
      },
      defaults: {
        文档类型: '用户手册',
        技术深度: '中级',
    ...
    c9: {
      ...
      values: {
        ...
        篇幅: ['Headline (1 line)', 'Short Copy (50-100 words)', 'Standard Copy (200-500 words)', 'Long-form Sales Page (1000+ words)', 'Email Sequence (Multi-part)'],
      },
      defaults: {
        文案类型: '落地页',
        说服策略: '利益驱动',
        情感诉求: '梦想激发',
        目标行动: '立即购买',
        篇幅: 'Standard Copy (200-500 words)',
      },
    },
    c10: {
      // Social Media Post
      ...
      values: {
        ...
        长度: ['Tweet-size (< 280 chars)', 'Short Post (50-100 words)', 'Standard Post (150-300 words)', 'Long-form Post (500+ words)', 'Thread / Carousel (Multi-slide)'],
      },
      defaults: {
        平台: 'Twitter/X',
        内容形式: '图文帖',
